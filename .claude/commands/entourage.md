...
- **Public role only**: publish only the person's public role and information already made public by an official source or by two independent outlets (GDPR data minimisation, art. 5). Never private life: address, family, personal wealth (including personal or family property companies, SCI / SCPI / GFA, even when declared to the HATVP), health, religious or political opinions beyond the public role.
